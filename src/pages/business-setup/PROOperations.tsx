      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            <Button className="bg-green-600 hover:bg-green-700" onClick={handleAssignNewTask}>
              Assign New Task
            </Button>
            <Button className="bg-blue-600 hover:bg-blue-700" onClick={handleAssignPRO}>
              Assign PRO Officer
            </Button>
          </div>
        }
              ...
              <div key={task.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  <div className="text-xs text-gray-600">
                    Assigned to: {task.officer} • Due: {task.dueDate}
                  </div>
                  <Button size="sm" variant="outline" onClick={() => handleUpdateStatus(task)}>Update Status</Button>
                </div>
              </div>
            ))}
          </div>
