...
export function EditPropertyModal({ isOpen, onClose, onSubmit, propertyData }: EditPropertyModalProps) {
  const [previewImage, setPreviewImage] = useState<string>(propertyData?.image || '');
  ...
  const handleClose = () => {
    setPreviewImage(propertyData?.image || '');
    setImageFile(null);
    onClose();
  };
        ...
        <div className="sticky top-0 bg-white z-10 flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Update property information</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                ...
                <Input 
                  id="title" 
                  name="title"
                  defaultValue={propertyData?.title || 'Luxury Villa with Pool'}
              ...
              <div>
                ...
                <Select name="type" defaultValue={propertyData?.type || 'villa'}>
              ...
              <div>
                ...
                <Select name="status" defaultValue={propertyData?.status || 'available'}>
                  <SelectTrigger className="mt-1.5">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Input 
                  ...
                  name="price"
                  type="number" 
                  defaultValue={propertyData?.price || '3200000'}
                  placeholder="2500000" 
                  className="mt-1.5" 
                  required 
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input 
                  id="location" 
                  name="location"
                  defaultValue={propertyData?.location || 'Dubai Hills Estate'}
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Input 
                  ...
                  name="bedrooms"
                  type="number" 
                  defaultValue={propertyData?.bedrooms || '5'}
                  placeholder="4" 
                  className="mt-1.5" 
                  required 
                />
              ...
              <div>
                ...
                <Input 
                  ...
                  name="bathrooms"
                  type="number" 
                  defaultValue={propertyData?.bathrooms || '6'}
                  placeholder="5" 
                  className="mt-1.5" 
                  required 
                />
              ...
              <div>
                ...
                <Input 
                  ...
                  name="area"
                  type="number" 
                  defaultValue={propertyData?.area || '4500'}
                  placeholder="3500" 
                  className="mt-1.5" 
                  required 
                />
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select name="agent" defaultValue="sarah">
                  <SelectTrigger className="mt-1.5">
          ...
          <div>
            ...
            <Textarea 
              id="description" 
              name="description"
              defaultValue="Stunning luxury villa located in the prestigious Dubai Hills Estate. This magnificent property features modern architecture, high-end finishes, and a private pool with landscaped garden."
