...
export function MobileSidebar({ isOpen, onClose, currentPage, onNavigate, selectedBrand, onBrandChange }: MobileSidebarProps) {
  ...
  const SectionTitle = ({ children }: { children: React.ReactNode }) => {
    const isRealEstate = selectedBrand === 'real-estate';
    return (
      <div className={`px-3 mt-6 mb-3 text-[11px] uppercase tracking-wider font-semibold ${
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <aside className={`fixed left-0 top-0 h-screen w-80 ${sidebarBg} shadow-2xl overflow-y-auto z-50 lg:hidden animate-in slide-in-from-left duration-300`}>
        {/* Header */}
